    ...
    <header class="px-4 py-2 shadow">
        <div class="flex justify-between">
            ...
            <div class="flex items-center">
                ...
                <img src="https://example.com/path-to-your-image.jpg" alt="Profile" class="h-8 w-8 rounded-full">

                    <span class="w-full input input-bordered">{{ auth()->user()->email }}</span>
            ...
            <div class="sidebar text-center bg-gray-900">
                ...
                <a href="{{ route('katalog.index') }}">
                    <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white">
                        ...
                        <span class="text-[15px] ml-4 text-gray-200 font-bold">Toko</span>
                    </div>
                </a>
